...
$(function(){
  ...
  if (window.location.pathname.match(/\/(.+)\/feed/)){
    var faye = new Faye.Client('http://localhost:9292/friends/feed/faye');
    faye.subscribe('/friends/feed/faye', function (data) {
